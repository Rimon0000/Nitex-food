...
const SinglePopularMenu = ({popular}) => {
    ...
    return (
        <div className='border border-primary bg-light rounded-lg' data-aos="fade-up" data-aos-duration="2000">
           <div className='lg:flex md:flex gap-10 mb-4 rounded'>
                <div className='lg:w-1/4 md:w-1/4'>
                    <img className='w-11/12 rounded-lg text-center m-3 pt-2' src={photo} alt="" />
                </div>
                <div className='lg:w-3/4 md:w-3/4 py-2 px-2'>
